...
@section('style')
<link rel="stylesheet" href="{{ asset('style/loginUser.css') }}">
@endsection
...
@section('content')
<div class="imgBlock">
    <img src="{{ asset('images/SIF-character.png') }}" alt="">
</div>
<div class="formBlock">
    ...
    <form action="{{ route('login') }}" method="post">
        @csrf
        <input type="text" name="cpf" id="cpf" placeholder="CPF" required autocomplete="off" maxlength="250">
        <div class="password">
            <label class="containerCheck">
                <input type="checkbox" checked="checked" id="eyeCheckbox" onclick="alterarTipoInput()">
            ...
            <input type="password" class="passInp" name="senha" placeholder="Senha" required minlength="8" maxlength="24" autocomplete="off">
        </div>
