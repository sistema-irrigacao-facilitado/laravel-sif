                    ...
                    <form action="{{ route('user.conf.update', $user->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            <div class="campoForm">
                                ...
                                <input type="text" name="name" id="name" class="form-control" maxlength="250"
                                    value="{{ $user->name }}">
                            </div>
                            ...
                            <div class="campoForm">
                                ...
                                <input type="email" name="email" id="email" class="form-control"
                                    placeholder="name@email.com" maxlength="200" value="{{ $user->email ?? '' }}">
                            </div>

                            <div class="campoForm"><a href="{{ route('user.password') }}" class="altSenha">Alterar Senha</a>
                            </div>
