...
@section('content')
    ...
    <div class="sectionDispositivos">
        ...
        @forelse ($devices as $device)
            <div class="dispositivo">
                <div class="dispL1">
                    <div class="disInfo">
                        <div class="indenDis">
                            <p class="getModelo">{{ $device->model }}</p>
                            <p class="getNum"></p> N°: {{ $device->numbering }}</p>
                        </div>
                        <div class="other">
                            <p>
                                @if ($device->ip != null)
                                    {{ 'Ligue o dispositivo e configure-o, assim terá acesso a todas as funcionalidade' }}
                                @endif
                            </p>
                        </div>
                    </div>
                    <div class="ancoragem">
                        <a href="{{ route('user.device.report', $device->id) }}" {{-- falta o tipo=1 --}}
                        ...
                        <a class="aButtonExcluir" class="popup-button" onclick="popup({{ $device->id }})"
                        ...
                        <a href="{{ route('user.device.config', $device->id) }}" class="config">
                    ...
                    <div class="dispL2">
                        ...
                        <div class="acoes">
                            {{-- <div class="acSepar">
                                <div class="actionFlex">
                                    <div class="toggle">
                                        <input type="checkbox" class="checkbox" id="a{{ $device->id }}"
                                            onclick="toggleMode({{ $device->id }} , 1, {{ $device->ip }})">
                                        <label class="switch" for="a{{ $device->id }}" onchange="togglePump()">
                                ...
                                <div class="actionFlex">
                                    <div class="toggle">
                                        <input type="checkbox" class="checkbox" id="m{{ $device->id }}"
                                            onclick="toggleMode({{ $device->id }}, 2, {{ $device->ip }})">
                                        <label class="switch" for="m{{ $device->id }}; ">
                                            <span class="slider"></span>
                                        </label>
                                    </div>
                                    <p>Manual</p>
                            ...
                            @if ($device->dataDevice->count() > 0)
                                <div class="acSepar">
                                    <div class="temperatura">
                                        @if ($device->dataDevice->first()->temperature != null)
                                            <svg height="50px" width="50px" version="1.1" id="Layer_1"
                                                ...
                                                <g id="SVGRepo_iconCarrier">
                                                    <circle style="fill:#CEE8FA;" cx="221.32" cy="381.469"
                                                        r="59.943">
                                                    </circle>
                                                    <g>
                                            ...
                                            <p class="dados">{{ $device->dataDevice->first()->temperature }} °C</p>
                                        @else
                                    ...
                                    <div class="umidade">
                                        @if ($device->dataDevice->first()->humidity != null)
                                            ...
                                            <p class="dados">{{ $device->dataDevice->first()->humidity }}%</p>
                                        @else
                    ...
                    <div class="dispL3">
                        <a href="{{ route('user.device.report', $device->id) }}">
                            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                <g id="SVGRepo_iconCarrier">
                        ...
                        <a class="excButtonL3" onclick="popup({{ $device->id }})" data-bs-toggle="modal"
        ...
        <a href="{{ route('user.device.add') }}" class="addDisposBlock">
        ...
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body text-center py-4">
                    ...
                    <h3>Tem certeza?</h3>
                    <div class="text-secondary">Você realmente deseja excluir este dispositivo de sua conta?</div>
                </div>
