                                    ...
                                    <tr>
                                        <form action="{{ route('filter.page', 'plants') }}" method="POST" id="filtro">
                                            ...
                                            <td>
                                                <div class="mb-3">
                                                    <div class="input-group">
                                                        <label class="input-group-text" for="common_name">Nome Comum: </label>
                                            ...
                                            <td>
                                                <div class="mb-3">
                                                    <div class="input-group">
                                                        <label class="input-group-text" for="scientific_name">Nome Cientifico: </label>
                                            ...
                                            <td>
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            ...
                                                            <a class="dropdown-item" href="{{ route('admin.device.edit', $item->id) }}">
                                                                Editar
                                                            </a>
