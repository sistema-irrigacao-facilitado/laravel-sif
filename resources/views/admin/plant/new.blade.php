        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 card">
                    <form action="{{ route('admin.plants.store') }}" method="post" enctype="multipart/form-data" class="card">
                        @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" step="0.1" class="form-control" name="scientific_name"
                                    ...
                                    <div class="col-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="humidity_tolerance" id="humidity_tolerance"
