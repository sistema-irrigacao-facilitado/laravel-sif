                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="common_name"
                                                    id="common_name" value="{{ $plant->common_name }}"
                                        ...
                                        <div class="col-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="scientific_name"
                                                    value="{{ $plant->scientific_name }}" placeholder="Nome Ciêntifico"
                                        ...
                                        <div class="col-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control cem" name="humidity_tolerance"
                                                    id="humidity_tolerance" value="{{ $plant->humidity_tolerance }}"
                                                    placeholder="Tolerancia Umidade" required aria-required="true"
                                                    max="100" step="0.01" min="0">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" step="0.1" class="form-control cem"
                                                    name="temperature_tolerance" id="temperature_tolerance" max="100"
                                                    placeholder="Tolerancia Temperatura"
                                                    value="{{ $plant->temperature_tolerance }}" step="0.01" required
                                                    aria-required="true">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-4">
                                            <div class="mb-3">
                                                ...
                                                <div class="actualImg">
                                                    <div class="img">
                                                        <img src="{{ asset('storage/' . $plant->image) }}" alt="">
                                                    </div>
